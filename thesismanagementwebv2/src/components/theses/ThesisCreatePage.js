...
// import { createCouncil, getCouncilById, updateCouncil } from "../../services/councilService";
// import { MyUserContext } from "../../configs/MyContexts";
// import MySpinner from "../layouts/MySpinner";
// import CouncilMembersEditor from "../council/CouncilMemberEditors";
...
//     const { items: availableTheses, loadMore, hasMore } = useLazyLoad(fetchAvailableTheses, filters);
...
//                     let formattedDefenseDate = "";
//                     if (data.defenseDate) {
//                         const date = new Date(data.defenseDate);
//                         if (!isNaN(date.getTime())) {
//                             formattedDefenseDate = date.toISOString().slice(0, 16); // Format chuẩn datetime-local
//                         } else {
//                             toast(t("invalid-defense-date-format"), "danger");
//                             console.warn("Invalid date:", data.defenseDate);
//                         }
//                     } else {
//                         console.warn("defenseDate is missing or null");
//                         toast(t("invalid-defense-date-format"), "danger");
//                     }

//                     setCouncil({
//                         name: data.name || "",
//                         defenseDate: formattedDefenseDate || null,
